...
var config = window.require("".concat(window.STORYBOOK_NAME, "/config/environment"));

var app = window.require("".concat(window.STORYBOOK_NAME, "/app")).default.create(Object.assign({
  autoboot: false,
  rootElement: rootEl
}, config.APP));
