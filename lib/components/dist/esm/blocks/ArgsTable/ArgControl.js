...
import { ArrayControl, BooleanControl, ColorControl, DateControl, NumberControl, ObjectControl, OptionsControl, RangeControl, TextControl } from '../../controls';
...
export var ArgControl = function ArgControl(_ref) {
  ...
  switch (control.type) {
    case 'array':
      return /*#__PURE__*/React.createElement(ArrayControl, _extends({}, props, control));
