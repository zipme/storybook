...
var ZoomElementWrapper = _theming.styled.div(function (_ref) {
  var _ref$scale = _ref.scale,
      scale = _ref$scale === void 0 ? 1 : _ref$scale,
      height = _ref.height;
  return (0, _browserSupportsCssZoom.browserSupportsCssZoom)() ? {
    '> *': {
      zoom: 1 / scale
    }
  } : {
...
function ZoomElement(_ref2) {
  ...
  var componentWrapperRef = _react.default.useRef(null);
  ...
  return /*#__PURE__*/_react.default.createElement(ZoomElementWrapper, {
    scale: scale,
    height: height
