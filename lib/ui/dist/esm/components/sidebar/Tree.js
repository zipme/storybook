...
var Node = /*#__PURE__*/React.memo(function (_ref2) {
  var item = _ref2.item,
      refId = _ref2.refId,
  ...
  if (isRoot(item)) {
    return /*#__PURE__*/React.createElement(RootNode, {
      ...
      "data-item-id": item.id,
      "data-nodetype": "root"
    }, item.name, /*#__PURE__*/React.createElement(Action, {
      type: "button",
...
var Root = /*#__PURE__*/React.memo(function (_ref3) {
...
export var Tree = /*#__PURE__*/React.memo(function (_ref4) {
  var isBrowsing = _ref4.isBrowsing,
      isMain = _ref4.isMain,
      refId = _ref4.refId,
      data = _ref4.data,
      highlightedRef = _ref4.highlightedRef,
