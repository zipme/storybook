...
var storyFnWarning = (0, _utilDeprecate.default)(function () {}, (0, _tsDedent.default)(_templateObject()));
...
var StoryStore = /*#__PURE__*/function () {
  ...
  _createClass(StoryStore, [{
    ...
    value: function addStory(_ref14, _ref15) {
      ...
      if (_stories[id]) {
        _clientLogger.logger.warn((0, _tsDedent.default)(_templateObject2(), id));
      }
