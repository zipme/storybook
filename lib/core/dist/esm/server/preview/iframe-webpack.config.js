...
export default (async function ({
  ...
  var headHtmlSnippet = await presets.apply('previewHead', getPreviewHeadHtml(configDir, process.env));
  var bodyHtmlSnippet = await presets.apply('previewBody', getPreviewBodyHtml(configDir, process.env));
  ...
  var entryTemplate = await fse.readFile( // TODO ANDREW maybe something simpler
