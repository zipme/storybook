export var plugins = [require.resolve('@babel/plugin-transform-shorthand-properties'), require.resolve('@babel/plugin-transform-block-scoping'),
/*
...
export var presets = [[require.resolve('@babel/preset-env'), {
