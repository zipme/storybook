...
describe('Panel', function () {
  it('should subscribe to setKnobs event of channel', function () {
    ...
    (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Panel.default, {
      api: testApi,
      active: true
    }));
  ...
  describe('handleChange()', function () {
    it('should set queryParams and emit knobChange event', function () {
      ...
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Panel.default, {
        api: testApi,
        active: true
      }));
      var testChangedKnob = {
  ...
  describe('groups', function () {
    ...
    it('should have no tabs when there are no groupIds', function () {
      ...
      var root = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_theming.ThemeProvider, {
