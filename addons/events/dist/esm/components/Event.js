...
var StyledTextarea = styled(function (_ref) {
  var shown = _ref.shown,
      failed = _ref.failed,
      rest = _objectWithoutProperties(_ref, ["shown", "failed"]);

  return /*#__PURE__*/React.createElement(Textarea, rest);
})({
  flex: '1 0 0',
...
var Item = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Wrapper, null, /*#__PURE__*/React.createElement(Label, {
      ...
      }), isTextAreaShowed ? /*#__PURE__*/React.createElement(Button, {
...
Item.getDerivedStateFromProps = function (_ref6, _ref7) {
  ...
  if (!isEqual(payload, prevPayload)) {
    var payloadString = json.plain(payload);
